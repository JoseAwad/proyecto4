...
<div class="container" style="width: 100%;">
        ...
        <tbody>
            ...
            foreach($dataAtrasada AS $value){
                ...
                echo "<td>".$value['nombreTarea']."</td>";
                 echo "<td><a href='../Controlador/tarea.php?accion=modificar&idTarea=".$value['idTarea']."' ><img src='img/ticket.png' width='24' height='24' /></a> </td>";
    ...
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-10 Formulario_Tareaa">
            <h1>Nueva Tarea</h1>
            <form action="../Controlador/tarea.php" method="POST">
              <input type="hidden" name="accion" value="agregarUsuario" id="accion">
